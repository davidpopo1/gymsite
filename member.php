...
<form>
  ...
  <div class="form-group">
    ...
    <input type="text" name="dob"class="form-control" id="inputAddress2" placeholder="">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Phone Number</label>
    <input type="text" name="phone"class="form-control" id="inputAddress2" placeholder="123-4567-8910">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Coach</label>
    <input type="text" name="coach"class="form-control" id="inputAddress2" placeholder="">
  </div>
